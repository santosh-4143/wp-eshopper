...
function smlsubform($atts=array()){
	...
	if ($showname) $return .= '<div class="form-group"><p class="sml_name"><label class="sml_namelabel sr-only" for="sml_name">'.$nametxt.'</label><input class="sml_nameinput form-control" placeholder="'.$nameholder.'" name="sml_name" type="text" value=""></p></div>';
	$return .= '<div class="form-group"><p class="sml_email"><label class="sml_emaillabel sr-only" for="sml_email">'.$emailtxt.'</label><input class="sml_emailinput form-control" name="sml_email" placeholder="'.$emailholder.'" type="text" value=""></p></div>';
	if ($showsubmit) $return .= '<p class="sml_submit"><input name="submit" class="btn sml_submitbtn btn-default" type="submit" value="'.($submittxt?$submittxt:'Submit').'"></p>';
	$return .= '</form>';
