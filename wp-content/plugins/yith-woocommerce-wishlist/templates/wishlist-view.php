...
<div class="myorder_wrap">
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <a href="../../my-account/edit-account/"><i class="fa fa-edit"></i>Edit Account</a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="col-lg-9 col-sm-9">
        <div class="customer_wishlist">
            <div class="box">
                <form action="checkout1.html" method="post">
                    <h1>Wishlist</h1>
                    <p class="text-muted">This is your currently whishlist items</p>
                                            ...
                                            <tr id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" data-row-id="<?php echo $item['prod_id'] ?>">
                                                ...
                                                <?php if ($show_last_column): ?>
                                                    <td class="product-add-to-cart">
                                                      ...
                                                      <td><a href="<?php echo esc_url(add_query_arg('remove_from_wishlist', $item['prod_id'])) ?>"><i class="fa fa-trash-o"></i></a></td>
                                                <?php endif; ?>
                                            </tr>
...
<!--                            <tfoot>
                    ...
                    <div class="box-footer">
                        <div class="pull-left">
                            <a href="../../shop"><button class="btn btn-primary" type="button"><i class="fa fa-chevron-left"></i> Continue shopping</button></a>
                        </div>
<!--                        <div class="pull-right">
                            <a href="basket.html"><button class="btn btn-primary" type="button">Proceed to basket <i class="fa fa-chevron-right"></i></button></a>
                        </div>-->
                    </div>
                </form>
            </div>
