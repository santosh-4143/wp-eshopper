            ...
            <div class="col-lg-4 col-sm-4">
            	<div class="about_wrap">
                    ...
                    <ul>
                        ...
                        <li class="s2"><a href="#"><i class="fa fa-rss"></i></a></li>
                        <li class="s3"><a href="#"><i class="fa fa-twitter"></i></a></li>
                        <li class="s4"><a href="#"><i class="fa fa-google-plus"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4">
    	...
    	<div class="container">
        	<div class="col-lg-3 col-sm-6">
            	<div class="footer_wrap">
                    ...
                    <p>Office # 2205, Prism TowerBusiness Bay, Dubai, UAE</p>
                    <h4>CONTACT</h4>
                    <p>Telephone: 04 2767632<br>Email: Contact@Thefashhub.Com</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
            	<div class="footer_wrap">
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="footer_wrap">
                    ...
                    <div class="tweet">
                    	<ul>
                        	<li>Wendy - Ecommerce PSD #Template.http://t.co/XB25IJJkFd. @plazathemes5h</li>
                            <li>Alexis - #Responsive #OpenCart #Theme. http://t.co/uEpCe2fcyX http://t.co/KnSxllsEaH22h</li>
                        </ul>
                    </div>
                    <div class="link">
                    	<ul>
                        	<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/icon/link1.png" alt="link" class="img-responsive"></a></li>
                            <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/icon/link2.png" alt="link" class="img-responsive"></a></li>
                            <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/icon/link3.png" alt="link" class="img-responsive"></a></li>
                            <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/icon/link4.png" alt="link" class="img-responsive"></a></li>
                            <li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/icon/link5.png" alt="link" class="img-responsive"></a></li>
                        </ul>
                    </div>	
                </div>
            </div>
